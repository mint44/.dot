...
WeirdCustom = [
    ...
    ["#c2454e", "#ef5847"],  # red
    ["#7cbf9e", "#a2d9b1"],  # green
    ["#8a7a63", "#beb090"],  # yellow
    ["#2e3340", "#61778d"],  # blue
    ["#ff5879", "#ff99a1"],  # magenta
    ["#44b5b1", "#9ed9d8"],  # cyan
    ["#f2f1b9", "#f6f6c9"],  # white
...
NavyAndIvory= [
    ["#021b21", "#021b21"],  # primary background
    ["#e8dfd6", "#e8dfd6"],  # primary foreground
    ["#032c36", "#065f73"],  # black
    ["#c2454e", "#ef5847"],  # red
    ["#7cbf9e", "#a2d9b1"],  # green
    ["#8a7a63", "#beb090"],  # yellow
...
def _loadWalColor():
    walcolor= os.path.expanduser('~/.cache/wal/colors.json')
    colordict = json.load(open(walcolor))
    ColorZ=(colordict['special']['background'])
    ColorA=(colordict['special']['foreground'])
    ...
    return [
        [ColorZ, ColorZ], # bg
        [ColorA, ColorA], # fg 
        [ColorB, ColorB], # color01 
        [ColorC, ColorC], # color02 
        [ColorD, ColorD], # color03 
        [ColorE, ColorE], # color04 
        [ColorF, ColorF], # color05 
        [ColorG, ColorG], # color06 
        [ColorH, ColorH], # color07 
    ]
WalColor = _loadWalColor()